...
const CreateBlog = () => {
const {blogData ,setBlogData,createBlogFun , isLoading}=useContext(BlogContext)
  return (
    <Layout>
      <div className="min-h-screen flex items-center justify-center bg-[#FFF] font-sans py-10 px-4">
        <div className="w-full max-w-[1000px] bg-white shadow-xl rounded-2xl px-8 py-10 border border-gray-100 ">
          ...
          <div className="  flex gap-2 md:gap-5 items-start  flex-wrap-reverse">
            {/* create blog  */}
            <form
              onSubmit={createBlogFun}
              className="flex-1">
              {/* Thumbnail */}
